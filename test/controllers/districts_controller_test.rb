...
class DistrictsControllerTest < ActionController::TestCase
  ...
  test "should create district" do
    assert_difference('District.count') do
      post :create, district: { districtName: @district.districtName, ncesleaCode: @district.ncesleaCode, zoneID: @district.zoneID }
    end
  ...
  test "should update district" do
    patch :update, id: @district, district: { districtName: @district.districtName, ncesleaCode: @district.ncesleaCode, zoneID: @district.zoneID }
    assert_redirected_to district_path(assigns(:district))
  end
