...
function postDistrict() {
	alert("postDistrict");
  $.ajax({
    url: 'https://srx-services-prs-dev.herokuapp.com/districts;zoneId=test;contextId=test',
    type: 'POST',
    dataType: 'xml',
		data: '';,
...
function passToController(response) {
	$.ajax({
    url: "/districts/" + response["createResponse"]["creates"]["id"],
    type: "GET",
    dataType: "json",
    data: { srx_data: response },
		success: function() {
			alert("success!");
		},
    error: function(message) {
