...
function postDistrict() {
  $.ajax({
    url: 'https://srx-services-prs-dev.herokuapp.com/districts;zoneId=' + <%= Rails.application.secrets.prs_zone_id %> + ';contextId=' + <%= Rails.application.secrets.prs_context_id %>,
    type: 'POST',
    dataType: 'xml',
